...
ActiveRecord::Schema.define(version: 2016_06_07_153249) do
  ...
  create_table "assignments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["person_id", "ministry_id"], name: "index_assignments_on_person_id_and_ministry_id", unique: true
  end
  ...
  create_table "church_values", force: :cascade do |t|
    ...
    t.string "period"
    t.index ["church_id", "period"], name: "index_church_values_on_church_id_and_period", unique: true
  end
  ...
  create_table "churches", force: :cascade do |t|
    ...
    t.index ["gr_id"], name: "index_churches_on_gr_id", unique: true
    t.index ["parent_id"], name: "index_churches_on_parent_id"
  end
  ...
  create_table "measurement_translations", force: :cascade do |t|
    ...
    t.index ["ministry_id"], name: "index_measurement_translations_on_ministry_id"
  end
  ...
  create_table "ministries", force: :cascade do |t|
    ...
    t.integer "area_id"
    t.index ["gr_id"], name: "index_ministries_on_gr_id", unique: true
    t.index ["min_code"], name: "index_ministries_on_min_code", unique: true
  end
  ...
  create_table "people", force: :cascade do |t|
    ...
    t.index ["cas_guid"], name: "index_people_on_cas_guid", unique: true
    t.index ["gr_id"], name: "index_people_on_gr_id", unique: true
  end
  ...
  create_table "stories", force: :cascade do |t|
    ...
    t.index ["church_id"], name: "index_stories_on_church_id"
    t.index ["created_by_id"], name: "index_stories_on_created_by_id"
    t.index ["ministry_id"], name: "index_stories_on_ministry_id"
    t.index ["training_id"], name: "index_stories_on_training_id"
  end
  ...
  create_table "training_completions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["training_id"], name: "index_training_completions_on_training_id"
  end
  ...
  create_table "trainings", force: :cascade do |t|
    ...
    t.index ["ministry_id"], name: "index_trainings_on_ministry_id"
  end
  ...
  create_table "user_content_locales", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["person_id", "ministry_id"], name: "index_user_content_locales_on_person_id_and_ministry_id", unique: true
  end
  ...
  create_table "user_map_views", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["person_id", "ministry_id"], name: "index_user_map_views_on_person_id_and_ministry_id", unique: true
  end
  ...
  create_table "user_measurement_states", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["person_id", "mcc", "perm_link_stub"], name: "unique_index_user_measurement_states", unique: true
  end
  ...
  create_table "user_preferences", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["person_id", "name"], name: "index_user_preferences_on_person_id_and_name", unique: true
  end
