...
RSpec.describe ChurchValue, type: :model do
  describe "#values_for" do
    let(:church) { FactoryBot.create(:church, size: 2, development: 2) }
    ...
    it "returns array with one value each" do
      FactoryBot.create(:church_value, church: church, period: "2015-11", size: 4, development: 4)
      FactoryBot.create(:church_value, church: church, period: "2015-12", size: 3, development: 3)
