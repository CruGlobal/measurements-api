  ...
  describe "#save" do
    context "with valid attributes" do
      ...
      context "but no ministry" do
        it "creates Measurement" do
          ...
          expect {
            @measurement_type.save
          }.to change(Measurement, :count).by(1).and(change(MeasurementTranslation, :count).by(0))
        end
      end
    ...
    context "with invalid attributes" do
      ...
      it "does not create Measurement and Translation" do
        expect {
          @measurement_type.save
        }.to change(Measurement, :count).by(0).and(change(MeasurementTranslation, :count).by(0))
      end
    end
  end
end
