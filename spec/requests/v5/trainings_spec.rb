...
RSpec.describe "V5::Trainings", type: :request do
  ...
  describe "GET /v5/training" do
    let!(:training) { FactoryBot.create(:training, ministry: ministry, date: 1.month.ago) }
    ...
    it "responds with trainings even as inheritted leader" do
      ...
      FactoryBot.create(:assignment, person: user, ministry: parent_ministry, role: :admin)
  ...
  describe "POST /v5/training" do
    ...
    let(:attributes) do
      FactoryBot.attributes_for(:training, ministry: ministry)
  ...
  describe "PUT /v5/training/:id" do
    ...
    let(:other_ministry) { FactoryBot.create(:ministry) }
    ...
    context "as admin" do
      ...
      it "updates training" do
        FactoryBot.create(:assignment, person: user, ministry: other_ministry, role: :admin)
